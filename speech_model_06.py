...
from readdata_06 import DataSpeech
...
class ModelSpeech():
    ...
    def creat_model(self):
        ...
        conv2 = Conv2D(filters=32 , kernel_size=[3,3] , padding='same' , use_bias=True , kernel_initializer='he_normal')(conv1)
        ...
        conv3 = Conv2D(filters=64 , kernel_size=[3,3] , padding='same' , use_bias=True , kernel_initializer='he_normal')(maxpool1)
        conv3 = BatchNormalization(epsilon=0.0002)(conv3)
        conv3 = Activation(activation='relu')(conv3)

        conv4 = Conv2D(filters=64 , kernel_size=[3,3] , padding='same' , use_bias=True , kernel_initializer='he_normal')(conv3)
        ...
        conv5 = Conv2D(filters=128 , kernel_size=[3,3] , padding='same' , use_bias=True , kernel_initializer='he_normal')(maxpool2)
        conv5 = BatchNormalization(epsilon=0.0002)(conv5)
        conv5 = Activation(activation='relu')(conv5)

        conv6 = Conv2D(filters=128 , kernel_size=[3,3] , padding='same' , use_bias=True , kernel_initializer='he_normal')(conv5)
        ...
        conv7 = Conv2D(filters=128 , kernel_size=[3, 3], padding='same', use_bias=True , kernel_initializer='he_normal')(maxpool3)
        conv7 = BatchNormalization(epsilon=0.0002)(conv7)
        conv7 = Activation(activation='relu')(conv7)

        conv8 = Conv2D(filters=128 , kernel_size=[3, 3], padding='same', use_bias=True , kernel_initializer='he_normal')(conv7)
        conv8 = BatchNormalization(epsilon=0.0002)(conv8)
        conv8 = Activation(activation='relu')(conv8)

        maxpool4 = MaxPooling2D(pool_size=[2, 2], strides=[2 , 2], padding='valid')(conv8)
