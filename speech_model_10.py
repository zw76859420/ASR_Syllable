...
from readdata_03 import DataSpeech
...
class ModelSpeech():
    ...
    def creat_model(self):
        ...
        conv1_1 = Conv2D(filters=16 , kernel_size=[3,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal')(input_data)
        conv1_1 = BatchNormalization(epsilon=0.0002)(conv1_1)
        conv1_2 = Conv2D(filters=16 , kernel_size=[3,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal')(conv1_1)
        ...
        conv1_3 = Conv2D(filters=32 , kernel_size=[3,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal')(maxpool1_1)
        conv1_3 = BatchNormalization(epsilon=0.0002)(conv1_3)
        conv1_4 = Conv2D(filters=32 , kernel_size=[3,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal')(conv1_3)
        ...
        conv1_5 = Conv2D(filters=64, kernel_size=[3, 3], padding='same', activation='relu', use_bias=True, kernel_initializer='he_normal')(maxpool1_2)
        conv1_5 = BatchNormalization(epsilon=0.0002)(conv1_5)
        conv1_6 = Conv2D(filters=64, kernel_size=[3, 3], padding='same', activation='relu', use_bias=True, kernel_initializer='he_normal')(conv1_5)
        ...
        maxpool1_3 = MaxPooling2D(pool_size=[2, 2], strides=None, padding='valid')(conv1_7)
        maxpool1_3 = Dropout(rate=0.3)(maxpool1_3)

        # conv1_7 = Conv2D(filters=128, kernel_size=[3, 3], padding='same', activation='relu', use_bias=True, kernel_initializer='he_normal')(maxpool1_3)
        # conv1_7 = BatchNormalization(epsilon=0.0002)(conv1_7)
        # conv1_8 = Conv2D(filters=128, kernel_size=[3, 3], padding='same', activation='relu', use_bias=True, kernel_initializer='he_normal')(conv1_7)
        ...
        reshape_1 = Reshape([200 , 1600])(maxpool1_3)

        # model = Model(inputs=input_data , outputs=reshape_1)
        # model.summary()

        conv2_1 = Conv2D(filters=16 , kernel_size=[3 , 3] , padding='same' , activation='relu' , use_bias=True ,kernel_initializer='he_normal')(input_data)
        conv2_1 = BatchNormalization(epsilon=0.0002)(conv2_1)
        conv2_2 = Conv2D(filters=16 , kernel_size=[3 ,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal')(conv2_1)
        ...
        conv2_3 = Conv2D(filters=32 , kernel_size=[3 ,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal')(maxpool2_1)
        conv2_3 = BatchNormalization(epsilon=0.0002)(conv2_3)
        conv2_4 = Conv2D(filters=32 , kernel_size=[3 ,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal')(conv2_3)
        ...
        conv2_5 = Conv2D(filters=64 , kernel_size=[3,3] , padding='same' , activation='relu' , use_bias=True ,kernel_initializer='he_normal')(maxpool2_2)
        conv2_5 = BatchNormalization(epsilon=0.0002)(conv2_5)
        conv2_6 = Conv2D(filters=64 , kernel_size=[3,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal')(conv2_5)
        ...
        maxpool2_3 = MaxPooling2D(pool_size=[2,2] , strides=None , padding='valid')(conv2_7)
        maxpool2_3 = Dropout(rate=0.3)(maxpool2_3)

        # conv2_7 = Conv2D(filters=128 , kernel_size=[5,5] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal')(maxpool2_3)
        # conv2_7 = BatchNormalization(epsilon=0.0002)(conv2_7)
        # conv2_8 = Conv2D(filters=128 , kernel_size=[5,5] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal')(conv2_7)
        ...
        reshape_2 = Reshape([200 , 1600])(maxpool2_3)

        conv3_1 = Conv2D(filters=16, kernel_size=[3, 3], padding='same', activation='relu', use_bias=True,kernel_initializer='he_normal')(input_data)
        conv3_1 = BatchNormalization(epsilon=0.0002)(conv3_1)
        conv3_2 = Conv2D(filters=16, kernel_size=[3, 3], padding='same', activation='relu', use_bias=True,kernel_initializer='he_normal')(conv3_1)
        ...
        conv3_3 = Conv2D(filters=32, kernel_size=[3, 3], padding='same', activation='relu', use_bias=True,kernel_initializer='he_normal')(maxpool3_1)
        conv3_3 = BatchNormalization(epsilon=0.0002)(conv3_3)
        conv3_4 = Conv2D(filters=32, kernel_size=[3, 3], padding='same', activation='relu', use_bias=True,kernel_initializer='he_normal')(conv3_3)
        ...
        conv3_5 = Conv2D(filters=64, kernel_size=[3, 3], padding='same', activation='relu', use_bias=True, kernel_initializer='he_normal')(maxpool3_2)
        conv3_5 = BatchNormalization(epsilon=0.0002)(conv3_5)
        conv3_6 = Conv2D(filters=64, kernel_size=[3, 3], padding='same', activation='relu', use_bias=True, kernel_initializer='he_normal')(conv3_5)
        ...
        maxpool3_3 = MaxPooling2D(pool_size=[2, 2], strides=None, padding='valid')(conv3_7)
        ...
        # conv2_8 = BatchNormalization(epsilon=0.0002)(conv2_8)
        # maxpool2_4 = MaxPooling2D(pool_size=[2,2] , strides=None , padding='valid')(conv2_8)
        reshape_3 = Reshape([200, 1600])(maxpool3_3)
        ...
        # model_data.summary()
        # plot_model(model_data , '/home/zhangwei/model.png' ,show_shapes=True)
        ...
        adam = Adam(lr=0.1, epsilon=1e-6, decay=10e-3)
    ...
    def test_model(self , datapath='' , str_dataset='dev' , data_count=1):
        ...
        try:
            ...
            for i in range(data_count):
                ...
                pre = self.predict(data_input=data_input , input_len=data_input.shape[0] // 8)
