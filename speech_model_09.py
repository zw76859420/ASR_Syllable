...
'''
   此脚本是用来测试8层dcnn模型，模型的结构架构为32-32-64-64-128-128-pool-128-128-128-pool-512-1422
'''
...
from readdata_09 import DataSpeech
...
class ModelSpeech():
    ...
    def creat_model(self):
        ...
        # seblock_1 = squeeze_excite_block_up(conv2, up_and_squeeze_shape=1, ratio=4)
        ...
        # seblock_2 = squeeze_excite_block_up(conv4, up_and_squeeze_shape=1, ratio=4)
        ...
        # seblock_3 = squeeze_excite_block_up(conv6, up_and_squeeze_shape=1, ratio=4)
        ...
        conv9 = Conv2D(filters=128 , kernel_size=[3, 3], padding='same', activation='relu', use_bias=True , kernel_initializer='he_normal')(conv8)
        conv9 = BatchNormalization(epsilon=0.0002)(conv9)
        # seblock_4 = squeeze_excite_block_up(conv9, up_and_squeeze_shape=1, ratio=4)
        maxpool4 = MaxPooling2D(pool_size=[2, 2], strides=None, padding='valid')(conv9)
