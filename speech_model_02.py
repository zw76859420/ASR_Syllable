...
from readdata_02 import DataSpeech
...
class ModelSpeech():
    ...
    def creat_model(self):
        ...
        maxpool4 = MaxPooling2D(pool_size=[2, 1], strides=None, padding='valid')(conv8)
        maxpool4 = Dropout(0.3)(maxpool4)

        reshape = Reshape([100 , 3200])(maxpool4)
        ...
        # model_data.summary()
        # plot_model(model_data , '/home/zhangwei/model_data_02.png')
