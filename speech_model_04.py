...
from readdata_04 import DataSpeech
...
class ModelSpeech():
    ...
    def creat_model(self):
        ...
        conv7 = Conv2D(filters=256, kernel_size=[3, 3], padding='same', activation='relu', use_bias=True , kernel_initializer='he_normal')(maxpool3)
        conv7 = BatchNormalization(epsilon=0.0002)(conv7)
        conv8 = Conv2D(filters=256, kernel_size=[3, 3], padding='same', activation='relu', use_bias=True , kernel_initializer='he_normal')(conv7)
        ...
        reshape = Reshape([100 , 3072])(maxpool4)
        dense1 = Dense(units=1024 , activation='relu' , use_bias=True , kernel_initializer='he_normal')(reshape)
