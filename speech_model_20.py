...
'''
   此脚本是用来测试10层dcnn模型，模型的结构架构为32-32-64-64-128-128-pool-128-128-pool-256-256-pool-512-1422
'''
...
from readdata_20 import DataSpeech
...
class ModelSpeech():
    ...
    def creat_model(self):
        ...
        conv1 = Conv2D(filters=32 , kernel_size=[3,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal' , kernel_regularizer=regularizers.l2(1e-5))(input_data)
        conv1 = BatchNormalization(epsilon=0.0002)(conv1)
        conv2 = Conv2D(filters=32 , kernel_size=[3,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal' , kernel_regularizer=regularizers.l2(1e-5))(conv1)
        ...
        conv3 = Conv2D(filters=64 , kernel_size=[3,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal' , kernel_regularizer=regularizers.l2(1e-5))(maxpool1)
        conv3 = BatchNormalization(epsilon=0.0002)(conv3)
        conv4 = Conv2D(filters=64 , kernel_size=[3,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal' , kernel_regularizer=regularizers.l2(1e-5))(conv3)
        conv4 = BatchNormalization(epsilon=0.0002)(conv4)
        # conv4 = Conv2D(filters=64 , kernel_size=[3,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal' , kernel_regularizer=regularizers.l2(1e-5))(conv4)
        # conv4 = BatchNormalization(epsilon=0.0002)(conv4)
        maxpool2 = MaxPooling2D(pool_size=[2,2] , strides=None , padding='valid')(conv4)
        maxpool2 = Dropout(0.2)(maxpool2)

        conv5 = Conv2D(filters=128 , kernel_size=[3,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal' , kernel_regularizer=regularizers.l2(1e-5))(maxpool2)
        conv5 = BatchNormalization(epsilon=0.0002)(conv5)
        conv6 = Conv2D(filters=128 , kernel_size=[3,3] , padding='same' , activation='relu' , use_bias=True , kernel_initializer='he_normal' , kernel_regularizer=regularizers.l2(1e-5))(conv5)
        ...
        conv7 = Conv2D(filters=256 , kernel_size=[3, 3], padding='same', activation='relu', use_bias=True , kernel_initializer='he_normal' , kernel_regularizer=regularizers.l2(1e-5))(conv6)
        ...
        conv9 = Conv2D(filters=256, kernel_size=[3, 3], padding='same', activation='relu', use_bias=True , kernel_initializer='he_normal' , kernel_regularizer=regularizers.l2(1e-5))(maxpool4)
        conv9 = BatchNormalization(epsilon=0.0002)(conv9)
        conv10 = Conv2D(filters=256 , kernel_size=[3, 3], padding='same', activation='relu', use_bias=True , kernel_initializer='he_normal' , kernel_regularizer=regularizers.l2(1e-5))(conv9)
        conv10 = BatchNormalization(epsilon=0.0002)(conv10)
        conv10 = Conv2D(filters=512 , kernel_size=[3, 3], padding='same', activation='relu', use_bias=True , kernel_initializer='he_normal' , kernel_regularizer=regularizers.l2(1e-5))(conv10)
        conv10 = BatchNormalization(epsilon=0.0002)(conv10)
        maxpool5 = MaxPooling2D(pool_size=[2 , 2] , strides=None , padding='valid')(conv10)
        maxpool5 = Dropout(0.2)(maxpool5)

        reshape = Reshape([100 , 6144])(maxpool5)
