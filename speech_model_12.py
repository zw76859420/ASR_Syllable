...
'''
   网络模型结构为32-32-64-64-128-128-512-1422：顶层为CTC的网络结构
'''
...
from readdata_12 import DataSpeech
...
class ModelSpeech():
    ...
    def creat_model(self):
        ...
        # maxpool4 = MaxPooling2D(pool_size=[2, 2], strides=None, padding='valid')(conv6)
        # maxpool4 = Dropout(0.1)(maxpool4)

        reshape = Reshape([100 , 6400])(maxpool3)
        ...
        dense2 = Dense(units=self.MS_OUTPUT_SIZE , use_bias=True , kernel_initializer='he_normal' , kernel_regularizer=regularizers.l2(1e-5))(dense1)
        ...
        adam = Adam(lr=0.0001 , epsilon=1e-6)
