...
class ModelSpeech():
    ...
    def creat_model(self):
        ...
        # dense1 = Dense(units=512 , activation='relu' , use_bias=True)(reshape_layer)
        dense2 = Dense(units=256 , use_bias=True , kernel_initializer='he_normal' , activation='relu' , kernel_regularizer=regularizers.l2(1e-7))(reshape_layer)
